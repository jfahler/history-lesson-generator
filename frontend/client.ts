 ...
 */
import { generate as api_lesson_generate_generate } from "~backend/lesson/generate";
...
export namespace lesson {
    ...
    export class ServiceClient {
         ...
         */
        public async generate(params: RequestType<typeof api_lesson_generate_generate>): Promise<ResponseType<typeof api_lesson_generate_generate>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/lesson/generate`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_lesson_generate_generate>
        }
    }
}
