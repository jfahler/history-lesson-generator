...
```bash
git remote add encore encore://history-lesson-generator-chf2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/history-lesson-generator-chf2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/history-lesson-generator-chf2/settings/integrations/github)
